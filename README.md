...
Download either the Vanilla or Warehouse pack from the releases page, extract the zip, and move the contents to
\[rained install dir\]\scripts\autoload.
the Warehouse pack will also contain any vanilla autotiles.

...
local name = "Ventbox Perforated" -- The name of this autotile
...
local topLeft = "Ventbox Perforated NW"
local topRight = "Ventbox Perforated NE"
local bottomRight = "Ventbox Perforated SE"
local bottomLeft = "Ventbox Perforated SW"

-- Tiles used for sides, going clockwise from top
local topTile = "Ventbox Perforated N"
local rightTile = "Ventbox Perforated E"
local bottomTile = "Ventbox Perforated S"
local leftTile = "Ventbox Perforated W"

local inner = "Ventbox Perforated" -- Tile used for the inside of the box
----------------------------------
